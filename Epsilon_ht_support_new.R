##### Title: Epsilon_ht_support_new.R
##### objective: h=1~H, t=1~T での消費機会Jごとの最適な消費量を出力する関数. 
##### Update: 2020/11/30

# 1周28 sec. 
max_utility_UP_new <- function(product_attri, lambda_beta_new, m, S_new_1, gamma, price_new, ep_sigma, j_com){
  ...
  max_Q_star_z = array(0, dim = c(66, 12933, 30))
  for (j in 1:30){
    for (i in 1: 12933){
